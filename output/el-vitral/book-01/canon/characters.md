...
> Keep entries tight; read in full on every chapter.
...
- **Physical (3 specifics):** (1) mide a la gente **por las manos**, postura de "asa de
  ...
  veta y el peso antes de hablar.
...
- **Magic relationship:** lee **marrón** (plebe); en verdad **Blanco×Negro**, sumidero apex.
  ...
  **blanco frío**.
- **Secrets they hold (writer-only):** es la **cura**, el último y único de su clase; su
  coste real es la **erosión de identidad** (imperceptible en el Libro I). Padre Negro,
  madre Blanca (misterios §14b #1, #2, #3).
- **First appearance:** ch 1

## Mauro — el tutor [FIJO · nombre Mauro · grimorio §9]
- **Role:** mentor; **ex-Iglesia** (ex-Lector del cribado) que ahora **expía**. *(Mauro =
  pardo/oscuro: rima en sordina con el marrón que camufla a Bruno.)*
- **Physical (3 specifics):** (propuesta, libre) (1) hombre mayor, gris y enjuto, su propio
  blanco apagado por los años y la penitencia; (2) manos manchadas de los reactivos del
  prisma; (3) mira **caras** —y manos— donde todos miran color: el único que sostiene una
  mirada.
...
- **Magic relationship:** investiga el apagado con instrumentos (prismas, la Lectura);
  capacidad de **lectura calibrada** del color. (Tono/color concreto: libre.)
- **Secrets they hold (writer-only):** busca exactamente lo que Bruno es para **deshacer su
  propio crimen** (devolver el yo a los que agrisó) — **no** revertir el apagado, que sabe
  imparable; su atención es interés, no afecto (shadow `el-tutor-tiene-agenda`). Destino:
  Bruno lo **agrisa** en el clímax (§14b #13; restaurable un instante en el Libro III).
- **First appearance:** ch 1

## Tilo — el líder verde (ideólogo) [FIJO · deuteragonista II-III · grimorio §8]
- **Role:** **menor en el Libro I** (arco pleno en II-III). Vecino verde; futuro ideólogo de
  *"los muchos, ningún amo"* que **cae en el despojo para vencer al despojo**.
- **Physical (3 specifics):** libre (verde campesino; nombre de árbol = tilo/linden). > TODO
...
- **Secrets they hold (writer-only):** será el rostro de que *la violencia hereda la violencia*
  (§14b #8, Libro II).
- **First appearance:** ch 3 (atisbado; no se nombra como "líder")
...
- **Current emotional state:** certeza, no dolor; celo honrado.
- **Relationships:** la Iglesia (su orden); Mauro (foil); Bruno (presa, sin saber su nombre).
- **Magic relationship:** usa el **test del complementario** (proyecta el complementario para
  forzar el tell); coloreado de alta casa al servicio de la Iglesia (tono: libre).
- **Secrets they hold (writer-only):** caza la **cura**, no al Devorador (confunde síntoma con
  enfermedad); muere acertando en el hecho y errando en el sentido (Libro III).
- **First appearance:** ch 10
